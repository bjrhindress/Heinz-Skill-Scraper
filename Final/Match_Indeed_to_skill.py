...
def scrape_page(page_num,job,city,state):
...
def scrape_pages(user_input_job,user_input_city,user_input_state):
    df=scrape_page(0,user_input_job,user_input_city,user_input_state)
    for x in range(1,5):
        temp=scrape_page(x,user_input_job,user_input_city,user_input_state)
...
def return_job_count(user_input_job,user_input_city,user_input_state):
    df=scrape_pages(user_input_job,user_input_city,user_input_state)
    skill_sums=list()
    for skill in skill_list:
